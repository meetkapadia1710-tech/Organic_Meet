...
const GLYPHS: Record<string, ReactNode> = {
  ...
  mysql: (
    <>
      <ellipse cx="12" cy="6.2" rx="7.5" ry="3.2" {...S} />
      <path d="M4.5 6.2v11.6c0 1.77 3.36 3.2 7.5 3.2s7.5-1.43 7.5-3.2V6.2" {...S} />
      <path d="M8 12.5c1.6 2.4 3.4 4 5.4 4.8" {...S} />
    </>
  ),
  sql: (
    <>
  ...
  redux: (
    <>
      <circle cx="12" cy="12" r="9.5" {...S} />
      <path d="M8.5 8.6c2-1.4 5-1.4 7 0M15.6 15.2c-.6 2.3-3 3.8-5.3 3.2M8.4 15.2c-2-1.3-2.8-4-1.7-6" {...S} />
    </>
  ),
  zustand: (
    <>
      <path d="M3.5 15c2-3.5 4-5.2 6-5.2 3 0 3.4 3.4 5.4 3.4 1.3 0 2.4-.8 3.6-2.4" {...S} />
      <circle cx="17" cy="7" r="1.8" {...S} />
    </>
  ),
  'html5': <Mono>H5</Mono>,
  'css3': <Mono>C3</Mono>,
  ...
  prisma: (
    <>
      <path d="M9.2 2.9 19 17.4a1 1 0 0 1-.55 1.5l-9.3 2.5a1 1 0 0 1-1.25-1.1l1.6-16.8a1 1 0 0 1 1.7-.6z" {...S} />
    </>
  ),
  rest: (
    <>
      <circle cx="12" cy="12" r="2.2" {...S} />
      <path d="M12 3.2v6.6M12 14.2v6.6M4.4 7.6l5.7 3.3M13.9 13.1l5.7 3.3M4.4 16.4l5.7-3.3M13.9 10.9l5.7-3.3" {...S} />
    </>
  ),
  ...
  github: (
    <>
      <path d="M9.2 20.6v-3c0-.9-.3-1.5-.7-1.8 2.4-.27 4.9-1.2 4.9-5.4a4.2 4.2 0 0 0-1.1-2.9c.1-.28.5-1.4-.1-2.9 0 0-.9-.3-3 1.1a10.3 10.3 0 0 0-5.4 0C1.7 4.3.8 4.6.8 4.6c-.6 1.5-.2 2.62-.1 2.9a4.2 4.2 0 0 0-1.1 2.9c0 4.18 2.5 5.12 4.9 5.4-.31.27-.59.75-.69 1.45-.62.28-2.19.76-3.15-.9" transform="translate(6.6 0)" {...S} />
    </>
  ),
  git: (
    <>
      <path d="m20.4 10.9-7.3-7.3a1.6 1.6 0 0 0-2.26 0L9.3 5.14l1.92 1.92a1.9 1.9 0 0 1 2.4 2.42l1.85 1.85a1.9 1.9 0 1 1-1.14 1.07l-1.73-1.73v4.55a1.9 1.9 0 1 1-1.56-.05V10.6a1.9 1.9 0 0 1-1.03-2.5L8.1 6.2l-4.5 4.5a1.6 1.6 0 0 0 0 2.26l7.3 7.3a1.6 1.6 0 0 0 2.26 0l7.24-7.24a1.6 1.6 0 0 0 0-2.26z" {...S} />
    </>
  ),
  postman: (
    <>
      <circle cx="12" cy="12" r="9.5" {...S} />
      <path d="m8 13.5 4.5-4.5a2.1 2.1 0 1 1 3 3l-4.5 4.5-3.6.6z" {...S} />
    </>
  ),
  vercel: (
    <>
      <path d="M12 3.6 21.6 20.4H2.4z" {...S} />
    </>
  ),
  render: (
    <>
      <circle cx="12" cy="12" r="9.5" {...S} />
      <path d="M12 6.5v11M6.5 12h11" {...S} />
    </>
  ),
  capacitor: (
    <>
      <path d="M15.5 2.8 21.2 8.5 8.5 21.2 2.8 15.5z" {...S} />
      <path d="M14.5 9.5 9.5 14.5" {...S} />
    </>
  ),
  vitest: (
    <>
      <path d="M3.2 5.4 12 21.2l8.8-15.8L12 7.6z" {...S} />
      <path d="m9 12 2.2 2.2L16 9.5" {...S} />
    </>
  ),
  'vs code': (
    <>
      <path d="M17.5 2.6 7.2 12 3.4 9.1 2 10l3.4 2-3.4 2L3.4 15l3.8-2.9 10.3 9.4 4.5-2.2V4.8z" {...S} />
    </>
  ),
  ...
  gemini: (
    <>
      <path d="M12 2.6c0 5.2 3.6 9 9 9.4-5.4.4-9 4.2-9 9.4 0-5.2-3.6-9-9-9.4 5.4-.4 9-4.2 9-9.4z" {...S} />
    </>
  ),
  groq: (
    <>
      <circle cx="12" cy="12" r="7.2" {...S} />
      <path d="M12 8.6a3.4 3.4 0 1 0 3.4 3.4V12" {...S} />
      <path d="M15.4 12v3.6" {...S} />
    </>
  ),
  hindsight: (
    <>
      <path d="M4 12a8 8 0 1 1 2.4 5.7" {...S} />
      <path d="M3.4 17.6 4 12l5.2 1.6" {...S} />
      <circle cx="12" cy="12" r="2" {...S} />
    </>
  ),
  prompt: (
    <>
      <path d="M4 5.5h16v11H12l-4.5 4v-4H4z" {...S} />
      <path d="M8.5 11h7" {...S} />
    </>
  ),
  ...
  algorithm: (
    <>
      ...
      <circle cx="12" cy="5.4" r="2.4" {...S} />
      <path d="M10.4 7.6 7.4 15.8M13.6 7.6l3 8.2M8.4 18h7.2" {...S} />
    </>
  ),
  dbms: (
    <>
      ...
      <path d="M9.5 17.4h5" {...S} />
    </>
  ),
  oop: (
    <>
      <rect x="2.8" y="2.8" width="8" height="8" rx="2" {...S} />
      <rect x="13.2" y="13.2" width="8" height="8" rx="2" {...S} />
      <path d="M10.8 6.8h4a2 2 0 0 1 2 2v4" {...S} />
    </>
  ),
  'operating system': (
    <>
      <rect x="3" y="4.5" width="18" height="12.5" rx="2" {...S} />
      <path d="M8 20.5h8M12 17v3.5" {...S} />
      <path d="M7.5 9h4M7.5 12.5h9" {...S} />
    </>
  ),
  network: (
    <>
      ...
      <path d="M3 12h18" {...S} />
      <path d="M12 2.8c2.4 2.6 3.6 5.6 3.6 9.2s-1.2 6.6-3.6 9.2c-2.4-2.6-3.6-5.6-3.6-9.2S9.6 5.4 12 2.8z" {...S} />
    </>
  ),
};
